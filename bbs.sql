...
CREATE TABLE IF NOT EXISTS `t_third_user` (
  ...
  `email` varchar(150) NOT NULL DEFAULT '' COMMENT '邮箱',
  `avatar` varchar(150) NOT NULL DEFAULT '' COMMENT '头像',
  `url` varchar(150) NOT NULL DEFAULT '' COMMENT '第三方用户接口地址',
  `htmlUrl` varchar(150) NOT NULL DEFAULT '' COMMENT 'github 地址',
  `createTime` int NOT NULL COMMENT '创建时间',
  `updateTime` int NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `t_article` (
  ...
  `contentType` varchar(32) NOT NULL COMMENT '类型',
  ...
  `sourceUrl` varchar(150) NOT NULL DEFAULT '' COMMENT '原文链接',
  `createTime` int NOT NULL COMMENT '创建时间',
  `updateTime` int NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY (`title`)
...
CREATE TABLE IF NOT EXISTS `t_comment` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `userId` int unsigned NOT NULL COMMENT '用户 ID',
  `entityType` varchar(32) NOT NULL COMMENT '评论实体类型',
...
CREATE TABLE IF NOT EXISTS `t_sysconfig` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `key` varchar(20) NOT NULL DEFAULT '' COMMENT '配置',
  `value` text NOT NULL COMMENT '配置值',
  `name` varchar(32) NOT NULL COMMENT '配置名称',
  `description` varchar(150) NOT NULL COMMENT '配置描述',
  `createTime` int NOT NULL COMMENT '创建时间',
  `updateTime` int NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY (`key`)
